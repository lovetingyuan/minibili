...
`
function c(l, o) {
  const r = new Function(...Object.keys(o), `return \`${l.trim()}\``)
  return t => {
    const n = r(...Object.values(o))
    let e
    if ((typeof t == 'string' ? (e = document.querySelector(t)) : (e = t), e))
      e.innerHTML = n
    else throw new Error('can not find mount container')
  }
}
const a = c(s, {
