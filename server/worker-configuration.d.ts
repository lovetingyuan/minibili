/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 59ad4a8b268b6572f4a08d69027ee0d1)
// Runtime types generated with workerd@1.20260317.1 2026-03-17 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "UserStorage";
	}
	interface Env {
		ASSETS: Fetcher;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "RESEND_FROM_EMAIL" | "EXPO_PUBLIC_SENTRY_DSN" | "SENTRY_AUTH_TOKEN" | "RESEND_API_KEY">> {}
}
