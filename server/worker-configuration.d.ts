/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7514bfc871b781d00b9e45b2c916d1b0)
// Runtime types generated with workerd@1.20260911.1 2026-03-17 nodejs_compat
interface __BaseEnv_Env {
	BILIBILI_PROXY_URL: "https://bili-proxy-iota.vercel.app";
	USER_STORAGE: DurableObjectNamespace<import("./worker/index").UserStorage>;
	USER_DIRECTORY: DurableObjectNamespace<import("./worker/index").UserDirectory>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "UserStorage" | "UserDirectory";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BILIBILI_PROXY_URL">> {}
}
