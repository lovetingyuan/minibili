/* eslint-disable */
// Generated by Wrangler by running `wrangler types server/worker-configuration.d.ts --config server/wrangler.jsonc --env-interface CloudflareBindings` (hash: cbdca634838a1bffa751365b4fc23659)
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<Cloudflare.Env, "EXPO_PUBLIC_SENTRY_DSN" | "SENTRY_AUTH_TOKEN">
  > {}
}
