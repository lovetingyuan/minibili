...
//   throw err
// }
const newVersion = '0.6.4'
const changes = '修复已知问题  添加直播人数和贡献榜'
const apkUrl = 'https://expo.dev/artifacts/eas/sVMqovWAAL63C6xPckieS5.apk' // latestBuildList[0].artifacts.buildUrl
